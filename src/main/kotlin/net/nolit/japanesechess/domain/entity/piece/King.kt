...
class King(override val position: Position, override val isBlack: Boolean): Piece(position, isBlack) {
    ...
    override fun promote(): Piece {
        throw IllegalCallerException("King cannot promote")
    }

    override fun toPieceInHand(): PieceInHand {
        throw IllegalCallerException("King cannot be obtained")
    }
