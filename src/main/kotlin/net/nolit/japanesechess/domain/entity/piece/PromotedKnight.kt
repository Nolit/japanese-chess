...
class PromotedKnight(override val position: Position, override val isBlack: Boolean): Piece(position, isBlack) {
    ...
    override fun promote(): Piece {
        throw IllegalCallerException("promoted knight cannot promote")
    }

    override fun toPieceInHand(): PieceInHand {
        return PieceInHand("Knight") { position -> Knight(position, !isBlack) }
    }
