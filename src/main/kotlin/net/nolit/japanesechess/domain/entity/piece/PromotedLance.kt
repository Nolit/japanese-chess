...
class PromotedLance(override val position: Position, override val isBlack: Boolean): Piece(position, isBlack) {
    ...
    override fun promote(): Piece {
        throw IllegalCallerException("promoted lance cannot promote")
    }

    override fun toPieceInHand(): PieceInHand {
        return PieceInHand("Lance") { position -> Lance(position, !isBlack) }
    }
