...
class PromotedSilverGeneral(override val position: Position, override val isBlack: Boolean): Piece(position, isBlack) {
    ...
    override fun promote(): Piece {
        throw IllegalCallerException("PromotedSilverGeneral cannot promote")
    }

    override fun toPieceInHand(): PieceInHand {
        return PieceInHand("SilverGeneral") { position -> SilverGeneral(position, !isBlack) }
    }

    override fun getName(): String {
        return "PromotedSilverGeneral"
    }
